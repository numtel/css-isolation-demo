/* http://www.x-tags.org/download?byob=,x-tag-core,x-tag-pseudo-outer,x-tag-transitions,WeakMap,MutationObserver,domtokenlist-polyfill,customelements-polyfill */ 
window.Platform = {};
